...
import { 
  FaHtml5, FaCss3Alt, FaJs, FaReact, FaNodeJs, FaGithub, FaPhp, FaSymfony, FaDocker, 
  FaDev,
  FaXRay,
  FaDatabase
} from 'react-icons/fa';
import { 
  SiTailwindcss, SiExpress, SiMysql, SiPostgresql, SiPostman, SiAngular 
} from 'react-icons/si';
...
export default function Home() {
  ...
  bases: {
    title: "Bases",
    subtitle: "Langages fondamentaux du développement web",
    gradient: "from-yellow-400 via-orange-400 to-red-500",
    items: [
      { name: 'HTML5', icon: <FaHtml5 />, color: 'text-orange-500' },
      { name: 'CSS3', icon: <FaCss3Alt />, color: 'text-blue-500' },
      { name: 'JavaScript', icon: <FaJs />, color: 'text-yellow-400' },
      { name: 'PHP', icon: <FaPhp />, color: 'text-purple-500', level: '' },
    ]
  },
  frameworks: {
    title: "Frameworks & Librairies",
    subtitle: "Outils modernes pour accélérer le développement",
    ...
    items: [
      ...
      { name: 'Symfony', icon: <FaSymfony />, color: 'text-indigo-500' },
      { name: 'NodeJs', icon: <FaNodeJs />, color: 'text-indigo-500' },
  ...
  databases: {
    ...
    subtitle: "Stockage et gestion des données",
  ...
  tools: {
    ...
    subtitle: "Environnements et outils de développement",
    ...
    items: [
      ...
      { name: 'Xampp', icon: <FaDatabase />, color: 'text-sky-500' },
  ...
  languages: {
    ...
    items: [
      { name: 'Français', icon: <GiTalk />, color: 'text-blue-700', level: 'Couramment' },
  ...
  return (
    <>
      ...
      {/* Floating and Aurora Animations */}
      <style jsx global>{`
        @keyframes float {
